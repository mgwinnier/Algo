...
3) Run old.py with python with date in format YYYY/MM/DD (python old.py 2024/12/18)
4) This will create a folder with the date run and save 3 excel files: processed data, odds, results
5) Open all three spreadsheets and check for any "N/A" data, odds should come in 95% of the time correct, though.
6) Merge column A and center it on processed data for each match up.
